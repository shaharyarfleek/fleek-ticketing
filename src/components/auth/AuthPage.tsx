            ...
            <div className="max-w-lg">
              ...
              <div className="flex items-center space-x-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-slate-500 font-medium">Support Hub</p>
                </div>
              </div>
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-slate-200/60 p-8 lg:p-12 relative overflow-hidden">
              ...
              <div className="lg:hidden text-center mb-8 relative z-10">
                <div className="flex items-center justify-center space-x-3 mb-4">
                  ...
                  <div>
                    <h1 className="text-2xl font-bold bg-gradient-to-r from-slate-900 to-slate-800 bg-clip-text text-transparent tracking-tight">
                      Fleek
                    </h1>
                    <p className="text-slate-500 text-sm">Support Hub</p>
                  </div>
                </div>
              </div>
