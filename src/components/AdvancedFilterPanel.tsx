...
import { X, Filter, Calendar, User, Building, Tag, AlertTriangle } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <div className="space-y-2">
              {['new', 'triaged', 'assigned', 'in_progress', 'awaiting_customer', 'awaiting_internal', 'escalated', 'resolved', 'closed'].map(status => (
