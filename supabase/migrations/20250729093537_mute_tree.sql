...
-- Insert users (using bcrypt hashed passwords)
INSERT INTO users (id, username, email, name, password_hash, role, department_id, security_questions) VALUES
-- Admin user (password: admin123)
('user-admin', 'admin', 'admin@fleek.com', 'System Administrator', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', 'dept-finance', '{"questions": [{"question": "What was the name of your first pet?", "answer": "fluffy"}, {"question": "What city were you born in?", "answer": "new york"}]}'::jsonb),

-- Finance Department
('user-sarah', 'sarah.chen', 'sarah@fleek.com', 'Sarah Chen', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'manager', 'dept-finance', '{"questions": [{"question": "What was the name of your first pet?", "answer": "buddy"}, {"question": "What city were you born in?", "answer": "chicago"}]}'::jsonb),
('user-rani', 'rani', 'rani@fleek.com', 'Rani', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'agent', 'dept-finance', NULL),
('user-hashim', 'hashim', 'hashim@fleek.com', 'Hashim', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'agent', 'dept-finance', NULL),

-- Operations Department
('user-marcus', 'marcus.johnson', 'marcus@fleek.com', 'Marcus Johnson', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'manager', 'dept-operations', NULL),
('user-husaain', 'husaain', 'husaain@fleek.com', 'Husaain Ali Moosa', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'agent', 'dept-operations', NULL),
('user-waris', 'waris', 'waris@fleek.com', 'Waris', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'agent', 'dept-operations', NULL),
('user-khurram', 'khurram', 'khurram@fleek.com', 'Khurram', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'agent', 'dept-operations', NULL),
('user-naeem', 'naeem', 'naeem@fleek.com', 'Naeem', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'agent', 'dept-operations', NULL),

-- Supply Department
('user-emily', 'emily.watson', 'emily@fleek.com', 'Emily Watson', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'manager', 'dept-supply', NULL),
('user-shahiq', 'shahiq', 'shahiq@fleek.com', 'Shahiq', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'agent', 'dept-supply', NULL),
('user-albash', 'albash', 'albash@fleek.com', 'Albash', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'agent', 'dept-supply', NULL),
('user-malik', 'malik', 'malik@fleek.com', 'Malik', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'agent', 'dept-supply', NULL),

-- Tech Department
('user-kevin', 'kevin.zhang', 'kevin@fleek.com', 'Kevin Zhang', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'manager', 'dept-tech', NULL),

-- Growth Department
('user-jessica', 'jessica.liu', 'jessica@fleek.com', 'Jessica Liu', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'manager', 'dept-growth', NULL),
('user-lissy', 'lissy', 'lissy@fleek.com', 'Lissy', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'agent', 'dept-growth', NULL),

-- CX Department
('user-isabella', 'isabella.moore', 'isabella@fleek.com', 'Isabella Moore', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'manager', 'dept-cx', NULL),
('user-abigail', 'abigail', 'abigail@fleek.com', 'Abigail', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'agent', 'dept-cx', NULL)
ON CONFLICT (id) DO NOTHING;
